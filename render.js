...
async function renderAll(){
  try{
    ...
    document.getElementById('acercaLead').textContent =
      'No se pudo cargar el contenido (content.json). Si estás abriendo este archivo directamente ' +
      'con doble clic, usa un servidor local (ver README) — los navegadores bloquean fetch() sobre file://.';
  }
}
